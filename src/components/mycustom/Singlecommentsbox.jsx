...
export default function Singlecommentsbox({comments, comment_num, comment_datetime, comment_authorId, comment_text, comment_anchor, className, thread_opId}) {
